...
var reLeft = new _dereq_('cached-constructors-x').RegExp('^[' + _dereq_('white-space-x').string + ']+');
var replace = ''.replace;
...
},{"to-string-x":3,"white-space-x":4}],2:[function(_dereq_,module,exports){
'use strict';
...
},{"is-symbol":2}],4:[function(_dereq_,module,exports){
/**
